    ...
    <>
      <MainLayout>
        <main className="bg-background max-w-full h-full flex flex-col justify-start items-start p-4 gap-4">
          ...
          <section className="w-full flex flex-row flex-wrap justify-between items-end gap-4 mt-4">
            ...
            <div className="flex w-64 h-10">
              <button className="bg-button-success py-2 px-4 rounded-lg w-full uppercase text-white font-bold"> Retirar </button>
            </div>
          </section>
        </main>
      </MainLayout>
